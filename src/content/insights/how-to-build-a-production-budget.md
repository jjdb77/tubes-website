...
We wrote about this separately in [how much contingency a production needs](/insights/how-much-contingency-does-a-production-need/), including the question of who is allowed to spend it.
...
A locked budget immediately starts being wrong, and that is normal. From that point the useful question is no longer "what did we plan to spend" but "what will this now finish at". That is the job of the [cost report](/insights/what-is-a-production-cost-report/), which compares the locked budget against what has been spent, what has been committed, and what is still to come.
...
That is the argument for keeping the budget, the commitments and the actuals in [one connected system](/platform/) rather than in a chain of exports: not that spreadsheets cannot model a budget (they model them very well), but that a budget disconnected from what is actually being spent stops telling you anything by about week three of the shoot.
