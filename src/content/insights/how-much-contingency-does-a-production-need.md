...
Without that, contingency does not get spent, it gets absorbed. Departments run slightly over, the overages are quietly covered, nobody makes a decision, and by week seven the reserve is gone and no one can produce a list of where it went. The [cost report](/insights/what-is-a-production-cost-report/) will show that it happened, but only in retrospect, and only as an aggregate.
...
Neither is a scandal. But the second one is worth knowing about before you build next year's budget on the same assumptions, which is the argument for keeping [historic actuals somewhere you can actually query them](/platform/) rather than in a folder of closed spreadsheets.
...
Related reading: [how to build a production budget](/insights/how-to-build-a-production-budget/) and [what is a production cost report](/insights/what-is-a-production-cost-report/).
