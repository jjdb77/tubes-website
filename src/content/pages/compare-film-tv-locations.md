...
sections:
  ...
  - type: feature
    ...
    lead: Scout here, then schedule and budget it in Tubes
    text: |
      A location choice ripples through the whole production: travel days, crew rates, the incentive, the schedule. In Tubes you schedule cast, crew and locations in one calendar, keep a budget per scenario in the right currency, and compare scenarios side by side before you commit.

      Tubes does not book locations and has no stake in any of them; the links above go straight to the owners and film commissions. Tubes makes the plan behind the choice reliable.
    image: /assets/images/tubes-agenda.png
    image_alt: Cast, crew and locations scheduled in the Tubes calendar
    media_position: left
    button:
  ...
  - type: faq
    ...
    items:
      - question: Can I book these locations through Tubes?
        answer: |
          No. This guide is free and independent: every entry links to the official site of the location or studio and to the film commission that covers it. You deal with them directly. Tubes is production management software, not a booking service.
      - question: How do I get my location or studio listed?
        answer: |
          Use the "Suggest a location" form on this page. Tell us what and where it is, add a link, and confirm you are entitled to submit it. Listing is free. Photos must be yours or come with a licence we can honour, with the photographer credited.
  ...
  - type: cta
    ...
    text: |
      See how Tubes schedules cast, crew and locations and keeps a budget per scenario, from the first shortlist to the final cost report.
    button:
      label: Request a Demo
      url: /contact/
---
