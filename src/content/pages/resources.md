...
sections:
  ...
  - type: cards
    ...
    cards:
      ...
      - image: /assets/images/locations-toledo.jpg
        ...
        text: |
          Places to shoot and studio space to hire across Europe. Search by what you need, see everything on a map with photos and links, and put up to three locations side by side. Or browse them [by country and type of place](/film-locations/).
  ...
  - type: cta
    ...
    text: |
      Tubes brings budgeting, planning and cost control together, so a location or country choice becomes a working budget instead of a guess.
    button:
