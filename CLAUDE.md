...
- **Omvang**: op 3 en 4-9-2026 uitgebreid van 63 naar **984 locaties** in dezelfde 21 landen, met onderzoeksagenten per land (twee rondes) en verrijkingsagenten die de praktische velden invulden. Verdeling: VK 123, Frankrijk 81, Duitsland 70, Nederland 69, Spanje 67, Polen 62, Italie 52, Tsjechie 51, Hongarije 49, Belgie 44, daarna de rest tussen 15 en 39. Daarvan hebben er 553 een vrije foto, 382 praktische gegevens (prijs, capaciteit, voorzieningen, geschiktheid, vergunning, logistiek) en 946 bronlinks. Doel was niet meer bezienswaardigheden maar **gewone productielocaties**: 'Theatre, arena & venue' (171) en 'Industrial & derelict' (155) zijn nu de grootste categorieen, met vervoer (109), kantoren en scholen (92), instellingen (53) en woningen (47) erachter; paleizen en kastelen staan op 20 en 29. Aanleiding: een beoordeling die terecht stelde dat 63 locaties (3 per land, vooral beroemde plekken) te dun zijn om een zoekmachine te heten. (Let op: het commitbericht van ab4ba35 noemt abusievelijk 1007; 984 is het juiste aantal.)
...
- Let op de **paginaomvang**: 619 locaties met foto's is 1,7 MB HTML (267 kB gzip), want de kaarten staan in de HTML (goed voor SEO) en dezelfde gegevens nog eens als JSON voor de kaart en de vergelijking. De zoektekst is al uit de kaarten gehaald en wordt in de browser opgebouwd. Boven de ~1.000 locaties moet er meer af: dan alleen de eerste 48 kaarten serverside renderen en de rest uit de JSON, met het SEO-verlies als afweging.
