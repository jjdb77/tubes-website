...
- **De vragenlijst staat op een eigen adres**: `/production-finance-health-check/assessment/` (`src/health-check-assessment.njk`). De zes gebieden met Strong / Could improve / Opportunity, plus een vrij veld "wat wil je besproken hebben". Twee manieren erheen:
