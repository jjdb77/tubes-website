...
- **`/api/contact/status`** geeft zonder inloggen ja/nee en aantallen: sleutel gezet, volume aanwezig, aantal bewaarde berichten en of de inhaalslag verstuurd is. Geen adressen, inhoud of sleutels. Bedoeld om op afstand te zien waarom een mail niet aankomt zolang /beheer een 503 geeft; mag weg zodra `ADMIN_PASSWORD` is gezet.
