...
- **De vragenlijst staat op een eigen adres**: `/production-finance-health-check/assessment/` (`src/health-check-assessment.njk`). Opzet: **alle vragen onder elkaar**, gegroepeerd per thema (planning en budgettering, uitgaven en controle, forecasting en rapportage), met bovenaan een voortgangsbalk "x of 9 answered". Rechts staat een paneel dat **meeloopt met het thema dat in beeld is** (scroll-spy in site.js, geen IntersectionObserver: meerdere blokken zijn tegelijk zichtbaar en dan blijft de eerste hangen). Na versturen komt het rapport in de plaats van de vragen. Een stappenversie is geprobeerd en op verzoek weer teruggedraaid: Joachim wil alle vragen tegelijk zien.
