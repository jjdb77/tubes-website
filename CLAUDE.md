...
- Movie Magic-exports (`test/fixtures/magic-movie-template.xlsx`): twee titelregels, categorieregels in kolom 1-2 met totaal in kolom 6, detailregels in kolom 3-5. Wordt herkend doordat een titelregel met één cel geen kopregel is, de sectiekolom op inhoud wordt gevonden (tekst op een minderheid van de regels, omschrijving daar leeg) en categorieregels zonder code/omschrijving in de detailkolommen overgeslagen worden.
